...
public class ParkingLot {//HAS A
    ...
    public static void main(String[] args) {
        ...
        cars[0].setInfo("BMW","i8","Black", LocalDate.of(2015,5,20),20000,1000);
        cars[1].setInfo("BMW","m4","Black", LocalDate.of(2016,5,20),20000,1000);
        cars[2].setInfo("BMW","m4","Black", LocalDate.of(2017,5,20),20000,1000);
        cars[3].setInfo("BMW","i8","Black", LocalDate.of(2018,5,20),20000,1000);
        cars[4].setInfo("BMW","x5","Black", LocalDate.of(2019,5,20),20000,1000);
        ...
        System.out.println("================================");
        //recall ALL BMW i8 that were bulid before 2016
