...
import Office_Hours.Practice_12_02_2020.ArraysListPractice1;
...
System.out.println(student1);//aron
        System.out.println(student2);//aron

        student2.setInfo("Daniel", 'M', LocalDate.of(1990, 10, 25), "B123", 3.2);

        System.out.println(student1);//daniel
        System.out.println(student2);//daniel
       */
        ...
        //Array to collection type==>Arrays.asList
        ...
        System.out.println("=====================================");
        //for finding the youngest&& oldest students
        ...
        System.out.println("===================================");
//        finding highest GPA and lowest GPA
        ...
        //collection to collection type directly in the ()
        femaleStudents.removeIf(p->p.gender=='M');//gender!='F'
