       ...
       Scanner input=new Scanner(System.in);
        ...
        System.out.println("Do you have a valid passport");
          ...
          if(validPassport.equalsIgnoreCase("yes")){
              ...
              String countries=input.nextLine();//above is next()
             ...
             cost+= (bags*50);//cost=cost+(bag*50)
              ...
              String namesOfPeople=input.nextLine();//above we have nextShort
              //it will absorb enter
              System.out.println("your ticket is booked to "+countries+
                      ". We have charged extra for the"+bags+
                      " bags but you are tarveling with"+
                      namesOfPeople+"So we are giving a discount.your total cost is"+cost);

          }else{cost=200;
              System.out.println("When was your passport expired?");
               int whenExpired=input.nextInt();

               cost+=whenExpired*75;
              System.out.println("which country are you planning to travel?");
              input.nextLine();
              String planningToTravel=input.nextLine();
              System.out.println("Will you be traveling next year?");
              String isTravel=input.next();
              if(isTravel.equalsIgnoreCase("yes")){
                  cost+=100;
              }else{
                  cost-=50;
              }
              System.out.println("Looks like your password has been expired for "+whenExpired
                              +"\n             but not to worry we will get it ready for you " +
                      "to travel to"+planningToTravel+"."+ "\nYour total cost has come out to "+cost+".");
          }
