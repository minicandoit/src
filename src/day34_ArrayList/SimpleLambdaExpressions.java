...
public class SimpleLambdaExpressions {
    public static void main(String[] args) {
        ...
        *///do not remove method in the loop
        ...
        numbers2.removeIf(p->p<7);//p represents element
       ...
       // scores.removeIf(p->p%5==0);
        ...
        employees2.addAll(Arrays.asList("Ahmed","Ahmed","Erjon","Ahmed","Ahmed","Adil","Afooza"));
        ...
        employees3.addAll(Arrays.asList("Ahmed","Ahmed","Erjon","Ahmed","Ahmed","Adil","Afooza"));
        employees3.removeIf(p->p.toLowerCase().contains("a")||p.toLowerCase().contains("r"));
        System.out.println(employees3);
        employees3.removeIf(p->p.contains(p));
        System.out.println(employees3);
