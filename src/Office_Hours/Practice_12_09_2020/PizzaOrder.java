...
public class PizzaOrder {
    public static void main(String[] args) {
        ...
        pizza1.customizedOrder("Small", 2, 2, 20);
        ...
        for(int i = 0; i <= cybertekPizza.length-1; i++) {
            ...
            pizza.customizedOrder("Medium", 2, 3, 18);
        ...
        for(int i = 1; i <= 60; i++ ) {
            ...
            medium.customizedOrder("Medium",2, 3, 18);

            Pizza large = new Pizza();
            large.customizedOrder("Large",3, 4, 18);

            Pizza small = new Pizza();
            small.customizedOrder("small", 1, 2, 18);
